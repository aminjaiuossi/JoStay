...
const MyBookings = () => {
  ...
  return (
    <div className='py-28 md:pb-35 md:pt-32 px-4 md:px-16 lg:px-24 xl:px-32'>
        ...
        upcoming trip reservationin one place. Plan your trips seamlessly with 
            ...
            {bookings.map((booking)=>(
              ...
              w-full border-b border-gray-300 py-6 first:border-t'>
                ...
                <div className='flex flex-col md:flex-row'>
                  <img onClick={() => {navigate(`/trips/${booking.trip._id}`); window.scrollTo({ top: 0, behavior: 'smooth' })}} src={booking.trip.images[0]} alt="trip-image" 
                  className='cursor-pointer min-md:w-44 rounded shadow object-cover'/>
                  <div className='flex flex-col gap-1.5 max-md:mt-3 min-md:ml-4'>
                      <p className='font-playfair text-2xl'>{booking.trip.name}
                      <span className='font-inter text-sm'> ({booking.trip.catogery})</span>
                      </p>
                ...
                <div className='flex flex-col items-start justify-center pt-3'>
                  <div className='flex items-center gap-2'>
                    <div className={`h-3 w-3 rounded-full ${booking.isPaid ? "bg-green-600":"bg-red-500"}`}></div>
