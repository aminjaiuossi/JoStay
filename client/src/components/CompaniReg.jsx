    ...
    justify-center bg-black/70'>
      <form className='flex bg-white rounded-xl max-w-4xl max-md:mx-2'>
        ...
        <div className='relative flex flex-col items-center md:w-1/2 p-8 md:p-10'>
          ...
          <p className='text-2xl font-semibold mt-6'>Register Your Compani</p>
          ...
          <div className='w-full mt-4'>
            ...
            className='border border-gray-200 rounded w-full px-3 py-2.5 mt-1 outline-orange-400 font-light' required/>
          </div>
          {/* Phone */}
          <div className='w-full mt-4'>
          ...
          <div className='w-full mt-4 max-w-60 mr-auto'>
            ...
            rounded w-full px-3 py-2.5 mt-1 outline-orange-400 font-light' required>
          ...
          <button className='bg-orange-500 hover:bg-orange-600 transition-all 
